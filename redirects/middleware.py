...
class RedirectMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        ...
        return self._find_response(redirects_list, Redirect.MATCH_EXACT, path) or \
               self._find_response(redirects_list, Redirect.MATCH_PREFIX, path) or \
               self._find_response(redirects_list, Redirect.MATCH_REGEX, path) or \
               None
